...
function Footer() {
    ...
    const whatsappUrl = 'https://chat.whatsapp.com/K3RtknarV8rHBDq4dJV6HQ';
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm">
                            ...
                            <li><Link to="/stats" className="hover:text-primary-400 transition-colors">Stats</Link></li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-4">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-12 h-12 bg-gradient-to-br from-green-400 to-green-600 rounded-full flex items-center justify-center hover:opacity-90 transition-opacity shadow-lg"
                            >
                                <svg className="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
